...
async function multiply() {
    ...
    document.getElementById("file_check").innerHTML = "檔案已儲存至桌面：" + document.getElementById("page").value + "x-" + file.name;
}
...
function load (){
    ...
    document.getElementById("select").innerHTML = file.name + "<br>點此可重新選擇";
